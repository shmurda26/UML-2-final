            ...
            while (proceed)
            {
                ...
                switch (MenuChoice)
                {
                    ...
                    case 3:
                        ...
                        Console.WriteLine("enter the pizza you want to edit#:");
                        string input = Console.ReadKey().KeyChar.ToString();
                        ...
                        try
                        {
                            ...
                            Pizza foundpizza = _menuCatalog.Read(result);
                            Console.WriteLine("insert new price");
                            Console.ReadLine();
                            string inputprice = Console.ReadLine();

                            int price = int.Parse(inputprice);


                            _menuCatalog.Update(foundpizza, price);
                        ...
                        { Console.WriteLine("wua wua wua try again"); }
                        break;
